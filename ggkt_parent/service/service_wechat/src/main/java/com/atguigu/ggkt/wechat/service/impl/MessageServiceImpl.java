...
public class MessageServiceImpl implements MessageService {
    ...
    private String aboutUs(Map<String, String> param) {
        StringBuffer msg = this.text(param, "Barry课堂现开设Java、HTML5前端+全栈、大数据、" +
                "全链路UI/UE设计、人工智能、大数据运维+Python自动化、" +
                "Android+HTML5混合开发等多门课程；同时，通过视频分享、" +
                "Barry学苑在线课堂、大厂学苑直播课堂等多种方式，" +
    ...
    private String subscribe(Map<String, String> param) {
        return this.text(param,"感谢你关注“Barry课堂”，可以根据关键字搜索您想看的视频教程，如：JAVA基础、Spring boot、大数据等").toString();
    }
